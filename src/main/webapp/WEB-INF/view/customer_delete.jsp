	...
	<c:param name="content">
		...
		<div class="container container-m">
			...
			<div class="d-flex justify-content-center">
				<table class="w-50 table table-striped table-bordered border-primary">
					<tbody>
						<tr>
			...
			<c:choose>
				<c:when test="${delete_execute == null }">
					<form action="customer_delete" method="post" class="text-center" autocomplete="off">
						<input type="hidden" name="customer_id" value="${customer.customer_id }"> ユーザーID：<input type="text" name="user_id"> パスワード：<input
							type="password" autocomplete="new-password" name="password"><br>
						<br>
